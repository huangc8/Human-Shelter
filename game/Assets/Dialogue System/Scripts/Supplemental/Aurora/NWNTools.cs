...
namespace PixelCrushers.DialogueSystem {
	...
	/// <summary>
	/// This static utility class provides tools to help run Neverwinter Nights
	...
	public static class NWNTools {
		...
		/// <code>NWNTools.RegisterNWScriptFunction(this, typeof(MyNWScriptClass).GetMethod("MyNWScript"));</code>
		/// Or in WinRT (which doesn't have GetMethod()):
		/// <code>NWNTools.RegisterNWScriptFunction(this, SymbolExtensions.GetMethodInfo(() => MyNWScript(null))););</code>
		/// </example>
